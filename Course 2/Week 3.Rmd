...
inference(y = weeks, data = nc, statistic = "mean", type = "ci",
          method = "theoretical", conf_level = 0.9)
```
...
```{r pick-your-own}
# type your code for the Exercise here, and Knit
#whether white moms are older than non-white moms
inference(mage,whitemom,nc,statistic = "mean",type = "ht",null = 0,alternative = "twosided",method = "theoretical")
```
